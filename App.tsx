...
function App(): React.JSX.Element {
  ...
  // detection, which silently no-ops when the new value equals the
  // current one (broke repeat presses of the SAME button when this was
  // previously wired as setState + a separate effect watching the id).
  React.useEffect(() => {
...
const styles = StyleSheet.create({
  ...
  errorText: { marginTop: 12, fontSize: 14, textAlign: 'center', paddingHorizontal: 20, maxWidth: 320 },
});
export default App;